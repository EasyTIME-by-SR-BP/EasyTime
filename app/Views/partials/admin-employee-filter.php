...
<div id="ceo-employee-filter" class="relative w-full min-w-0 max-w-full bg-white rounded-3xl shadow-xl border border-lime-100 px-4 sm:px-7 py-3 overflow-hidden">
